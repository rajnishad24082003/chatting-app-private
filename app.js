...
app.get(
  "/google/callback",
  passport.authenticate("google", { failureRedirect: "/components/signin" }),
  (req, res) => {
    res.redirect("/on_signin_pages/storiesPage/user_typed_data");
  }
);
...
app.get("/components/sigin", (req, res) => {
  res.sendFile("/public/components/signin.html", {
    root: path.join(__dirname),
  });
});
app.use(
  "/on_signin_pages/storiesPage/user_typed_data",
  require("./folder_for_dashboard/routerforuserdata")
);
